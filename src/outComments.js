import { loggedUser, addSubComment, updateComment, allComments } from "./backend.js"
...
function configText(textContainer, answerTo, text) {
    ...
    if (answerTo) textContainer.innerHTML = `<span class='answer-reference' id='${answerTo.userId}'>@${answerTo.username}</span>`
